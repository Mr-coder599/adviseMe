...
import 'package:adviseme/Adviser_Screen/LandPage.dart';
import 'package:adviseme/Adviser_Screen/People.dart';
...
class DrawerAgent extends StatelessWidget {
  DrawerAgent({Key? key, required this.user}) : super(key: key);
  final User user;
